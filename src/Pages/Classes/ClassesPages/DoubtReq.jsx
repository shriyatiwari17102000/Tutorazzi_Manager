...
import HomeworkCard from './HomeworkCard/DoubtCard'
import DoubtCard from './HomeworkCard/DoubtCard'
...
useEffect(() => {
  ...
  const getDoubtData = async () => {
    ...
    let register = `${BASE_URL}/doubts?limit=${limit}&page=${page}&search=${search}&date=${dateValue}&teacher_id=${teacher}&student_id=${student}`
  ...
  useEffect(() => {
    getDoubtData()
  }, [limit, page, search, value, student, teacher])
  ...
  return (
    <React.Fragment>
      <Heading cls={classes.heading} heading={'Doubt Requests'} p={'Porem ipsum dolor sit amet, consectetur adipiscing elit.'}>
     ...
     <div className={classes.sb_div}>
      ...
      {rescheduleData.length > 0 ? <div>
        ...
        <DoubtCard key={index} func={getDoubtData}  data={item}   />
